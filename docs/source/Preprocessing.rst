...
One automated customization that is avaliable is the one to create atom type definitions for ligands of interest. For that you will need to create and assess a pdb file with only the ligand of interest using the following functions::
