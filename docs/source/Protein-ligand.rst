...
Now you will have the updated atom type definitions containing the atoms of PRL at the file custom_AMINO_FlexAID.def.

The following step is to clean the structure from any non-defined atom in the now updated .def file, meaning any atom that is not defined for the residues or the PRL ligand - in the case of this example, atoms from SO4, EDO and HOH, as well as ZN atoms::
